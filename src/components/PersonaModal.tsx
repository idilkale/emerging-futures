          ...
          >
            ...
            <div className="flex min-h-0 flex-1 flex-col overflow-hidden md:flex-row">
              ...
              <div className="min-h-0 flex-1 overflow-y-auto bg-paper p-8 md:p-10">
                ...
                <div className="mt-8">
                  <p className="label-mono !font-medium text-[#747474]">In their shoes</p>
